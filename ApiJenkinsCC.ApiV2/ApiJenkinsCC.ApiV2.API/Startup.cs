using AutoMapper;
using ApiJenkinsCC.ApiV2.API.Common.Attributes;
using ApiJenkinsCC.ApiV2.API.Common.Extensions;
using ApiJenkinsCC.ApiV2.API.Common.Settings;
using ApiJenkinsCC.ApiV2.IoC.Configuration.Profiles;
...
using System.IO;
using ApiJenkinsCC.ApiV2.API.Controllers;
using Microsoft.AspNetCore.Mvc.Versioning.Conventions;
using ApiJenkinsCC.ApiV2.API.Swagger;

namespace ApiJenkinsCC.ApiV2.API
{
